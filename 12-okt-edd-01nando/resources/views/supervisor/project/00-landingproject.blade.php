    ...
    <div class="my-20 mx-10">
        ...
        <div class="justify-between flex ">
            <div class="tracking-wide text-gray-600 mb-2">
                <p class=" font-light text-2xl">Your Project Dashboard</p>
        ...
        <div>
            ...
            <div class="mt-4">
                ...
                <div class="mx-auto md:w-9/12 xl:w-9/12 2xl:w-9/12">
                                                ...
                                                <div class="container">
                                                    ...
                                                    @if ($object->id == $object->koneksikefr->id_fr_1 &&
                                                        ...
                                                        <a
                                                            ...
                                                            <p
                                                                class="mb-1 text-3xl font-semibold tracking-normal text-gray-900 hover:underline">
                                                                {{ $object->project_name }}
                                                            </p>
                                                        </a>
                                                    @endif
