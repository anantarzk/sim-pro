        ...
        <div class="flex items-center">
            ...
            <div class="flex items-center relative">
                @if ($koneksimn->status_mn == 'Complete')
                    <div class="rounded-full h-12 w-12 py-2 px-3 bg-green-600 border-orange-500 border-4">
                        <p class="font-bold text-md text-white">M</p>
                    </div>
                @else
                    <div class="rounded-full h-12 w-12 py-2 px-3 bg-gray-400 border-orange-500 border-4">
                        <p class="font-bold text-md text-white">M</p>
                    </div>
                @endif
                <div class="absolute top-0 -ml-10 text-center mt-14 w-32 text-xs font-medium uppercase">
                    ...
                    <p class="text-center">{{ $koneksimn->status_mn }}</p>
                    <p class="text-center">{{ $koneksimn->status_mn_date }}</p>
                </div>
            </div>
