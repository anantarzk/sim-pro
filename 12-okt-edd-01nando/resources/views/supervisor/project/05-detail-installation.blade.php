        ...
        <div class="flex items-center">
            ...
            <div class="flex items-center relative">
                @if ($koneksiin->status_in == 'Complete')
                    <div class="rounded-full h-12 w-12 py-2 px-4 bg-green-600 border-orange-500 border-4">
                        <p class="font-bold text-md text-white">I</p>
                    </div>
                @else
                    <div class="rounded-full h-12 w-12 py-2 px-4 bg-gray-400 border-orange-500 border-4">
                        <p class="font-bold text-md text-white">I</p>
                    </div>
                @endif
                <div class="absolute top-0 -ml-10 text-center mt-14 w-32 text-xs font-medium uppercase">
    ...
    <div class="bg-white  mt-10  w-full rounded-t">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="text" hidden name="aktivitas"
                value="{{ Auth::user()->first_name }} - Memperbarui dan Menyetujui Installation pada project id={{ $viewdataproject->id }}">
        ...
        <div class="grid grid-cols-2 gap-2">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                {{-- input ke table log activity --}}
                <input type="text" hidden name="aktivitas"
                    value="{{ Auth::user()->first_name }} - Menyetujui Installation pada project id={{ $viewdataproject->id }}">
                <input type="text" hidden name="waktu" value="{{ date('d-m-Y H:i') }}">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                {{-- input ke table log activity --}}
                <input type="text" hidden name="aktivitas"
                    value="{{ Auth::user()->first_name }} - Memberi Revisi Installation pada project id={{ $viewdataproject->id }}">
                <input type="text" hidden name="waktu" value="{{ date('d-m-Y H:i') }}">
