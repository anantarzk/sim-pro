...
class StaffProjectController extends Controller
{
    ...
    {
        // if (isset($request->kondisi)cari
        //     dd($request->query);
        // }
        /* DB::enableQueryLog(); */
        $users = User::select('section', 'first_name')->get();
        $keyword = $request->keyword;
        $totalproject = CONTROLPROJECT::select(
            'id',
            'pic_1_me',
            'pic_2_el',
            'pic_3_mit',
            ...
            ->where('pic_1_me', Auth::user()->first_name)
            ->OrWhere('pic_2_el', Auth::user()->first_name)
        ...
        /* if ($request->kondisi == 'cari' && $request->keyword != '' && $request->budget_amount_max == '' && $request->budget_amount_min == '') {
            $project = CONTROLPROJECT::with(
                'koneksikefr',
                'koneksikear',
                'koneksikepr01',
                ...
                ->latest('updated_at')
                ->paginate(20);
        } else if ($request->kondisi == 'cari' && $request->nilai_proyek_type != '' && $request->budget_amount_max == '' && $request->budget_amount_min == '') {
        ...
        } else if ($request->kondisi == 'cari' && $request->budget_amount_max != '' && $request->budget_amount_min != '' && $request->keyword == '') {
        ...
        //dd($project);
        /* selesai kode cari */
        /* $request->keyword == '' && $request->nilai_proyek_type == '' && $request->budget_amount_max == '' && $request->budget_amount_min == '' */
        $filterMessage = '';
        if ($request->kondisi == 'cari' && ($request->pic_1_me || $request->pic_2_el || $request->pic_3_mit)) {
            $project = CONTROLPROJECT::with(
                'koneksikefr',
                'koneksikear',
                'koneksikepr01',
    ...
    public function SatuFormProgress(
        ...
        // Melanjutkan ke view
        return view('staff.project.01-detail-fundrequest', [
    ...
    public function DuaFormProgress(
        ...
        // Melanjutkan ke view
        return view('staff.project.02-detail-arrangement', [
            'viewdataproject' => $viewdataproject,
            'koneksifr' => $koneksifr,
            'koneksiar' => $koneksiar,
            'koneksipr' => $koneksipr,
    ...
    public function TigaTitikSatuFormProgress(
        ...
        // Melanjutkan ke view
        return view('staff.project.03-01-detail-purchasing', [
            'viewdataproject' => $viewdataproject,
            'koneksifr' => $koneksifr,
            'koneksiar' => $koneksiar,
            'koneksipr' => $koneksipr,
    ...
    public function TigaTitikDuaFormProgress(
        ...
        // Melanjutkan ke view
        return view('staff.project.03-02-detail-purchaseapproval', [
            'viewdataproject' => $viewdataproject,
            'koneksifr' => $koneksifr,
            'koneksiar' => $koneksiar,
            'koneksipr' => $koneksipr,
    ...
    public function TigaTitikTigaFormProgress(
        ...
        // Melanjutkan ke view
        return view('staff.project.03-03-detail-purchaseorder', [
            'viewdataproject' => $viewdataproject,
            'koneksifr' => $koneksifr,
            'koneksiar' => $koneksiar,
            'koneksipr' => $koneksipr,
    ...
    public function TigaTitikEmpatFormProgress(
        ...
        // Melanjutkan ke view
        return view('staff.project.03-04-detail-payment', [
            'viewdataproject' => $viewdataproject,
            'koneksifr' => $koneksifr,
            'koneksiar' => $koneksiar,
            'koneksipr' => $koneksipr,
    ...
    public function EmpatFormProgress(
        ...
        // Melanjutkan ke view
        return view('staff.project.04-detail-manufacturing', [
            'viewdataproject' => $viewdataproject,
            'koneksifr' => $koneksifr,
            'koneksiar' => $koneksiar,
            'koneksipr' => $koneksipr,
    ...
    public function LimaFormProgress(
        ...
        // Melanjutkan ke view
        return view('staff.project.05-detail-installation', [
            'viewdataproject' => $viewdataproject,
            'koneksifr' => $koneksifr,
            'koneksiar' => $koneksiar,
            'koneksipr' => $koneksipr,
    ...
    public function EnamFormProgress(
        ...
        // Melanjutkan ke view
        return view('staff.project.06-detail-closed', [
            'viewdataproject' => $viewdataproject,
            'koneksifr' => $koneksifr,
            'koneksiar' => $koneksiar,
            'koneksipr' => $koneksipr,
