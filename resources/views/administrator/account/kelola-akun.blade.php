    ...
    <div class="flex justify-between mb-3">
        ...
        <div class="w-2.5/">
            <a href="/registrasi-account">
                <button type="button"
                    class="text-white bg-gradient-to-r from-green-500 via-green-600 to-green-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm p-3 text-center mt-2 mb-2 inline-flex items-center">
