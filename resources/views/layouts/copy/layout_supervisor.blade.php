                                ...
                                <ul class="py-1" aria-labelledby="user-menu-button">
                                    ...
                                    <li>
                                        <a class="block py-2 px-4 text-xs text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-600 dark:hover:text-white"
                                            href="/view_team_supervisor">View Team</a>
                                    </li>
                                    <li>
                                        <a class="block py-2 px-4 text-xs text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-600 dark:hover:text-white"
            ...
            <ul class="space-y-2">
                ...
                <li class="">
                    <a href="/tambah-standar-project"
                        ...
                        <span class="ml-5 flex-1">Standard Project</span>
                    </a>
                </li>
                <li class="">
                    <a href="/progress-approval-supervisor"
                        ...
                        <span class="ml-5 flex-1">Approval Project</span>
                    </a>
                </li>
