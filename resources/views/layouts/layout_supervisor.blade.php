    ...
    <div id="sidebar"
        ...
        <div class="py-4 overflow-y-auto">
            <ul class="space-y-2">
                ...
                <li>
                    <a class="flex items-center rounded-lg py-2 px-3 text-base font-semibold text-white hover:bg-red-600 decoration-red-600"
                ...
                <li class="">
                    <a href="/progress-approval-supervisor"
                        class="flex items-center rounded-lg p-2 text-base font-semibold text-white hover:bg-red-600 decoration-red-600">
                        <svg width="26" height="auto" viewBox="0 0 31 31" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M13.366 25.534L11.966 24.29C11.266 23.66 10.726 22.88 10.386 22L8.376 16.45C8.206 15.98 8.426 15.46 8.876 15.25C9.116 15.14 9.356 15.09 9.606 15.09C10.236 15.09 10.846 15.441 11.156 16.04L12.996 19.74C13.616 19.28 13.976 18.55 13.976 17.79V6C13.976 5.17 14.646 4.5 15.476 4.5C16.306 4.5 16.976 5.17 16.976 6V14C16.976 13.17 17.646 12.5 18.476 12.5C19.306 12.5 19.976 13.17 19.976 14V14.5C19.976 13.67 20.646 13 21.476 13C22.306 13 22.976 13.67 22.976 14.5V15.5C22.976 14.67 23.646 14 24.476 14C25.306 14 25.976 14.67 25.976 15.5V23.59C25.976 24.265 25.773 24.923 25.402 25.481M12.976 30V27H25.976V30M9.953 5.041C9.968 5.191 9.976 5.345 9.976 5.5C9.976 7.979 7.967 9.988 5.488 9.988C3.009 9.988 1 7.979 1 5.5C1 3.021 3.01 1.012 5.488 1.012C6.281 1.012 7.027 1.219 7.674 1.58M9.789 2.342L5.488 6.643L3.416 4.571M26.976 7L23.976 4M26.976 4L23.976 7M29.976 5.5C29.976 7.98528 27.9613 10 25.476 10C22.9907 10 20.976 7.98528 20.976 5.5C20.976 3.01472 22.9907 1 25.476 1C27.9613 1 29.976 3.01472 29.976 5.5Z"
                                stroke="white" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                        <span class="ml-5 flex-1">Daftar Progress Approval</span>
                    </a>
                </li>
