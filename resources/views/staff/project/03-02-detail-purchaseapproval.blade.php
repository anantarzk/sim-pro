...
<div class="mx-10 my-20">
    ...
    <div class="tracking-wide mb-2">
        <p class=" font-mono font-bold text-3xl mb-3">Detail proyek - PA:</p>
    </div>
    {{-- akhir header --}}
    ...
    <div class="bg-white mt-3 w-full rounded-md shadow-md p-3">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="w-full mt-3">
                ...
                <div id="defaultTabContent">
                    <div class="bg-white mt-3" id="lokal" role="tabpanel" aria-labelledby="lokal-tab">
                        ...
                        <div class="flex justify-between">
                            <p class="font-medium text-lg bg-gray-800 px-4 py-1 w-fit text-white mb-2 rounded"> PA Parts & Material
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            @if ($koneksipa->pa_parts_46 != '')
                                                <a href="{{ asset('storage/supervisor/project/03_02_PR/' . $koneksipa->pa_parts_46) }}"
                                                    target="blank" class=" py-2 px-1 rounded  hover:bg-gray-200   ">
                                                    <svg width="22" height="17" viewBox="0 0 22 17"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_02_PR/' . $koneksipa->pa_parts_46) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipa->pa_parts_46 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipa->up_by_parts_pa_46 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipa->up_by_parts_pa_46 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipa->date_pa_parts_46 }}</td>
                                        <td>
                                            @if ($koneksipa->mny_parts_pa_46 != '')
                                                Rp{{ number_format($koneksipa->mny_parts_pa_46, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        ...
                                        <input type="text" hidden name="as_up_by_parts_pa_46"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pa_parts_46"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            @if ($koneksipa->pa_parts_47 != '')
                                                <a href="{{ asset('storage/supervisor/project/03_02_PR/' . $koneksipa->pa_parts_47) }}"
                                                    target="blank" class=" py-2 px-1 rounded  hover:bg-gray-200   ">
                                                    <svg width="22" height="17" viewBox="0 0 22 17"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_02_PR/' . $koneksipa->pa_parts_47) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipa->pa_parts_47 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipa->up_by_parts_pa_47 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipa->up_by_parts_pa_47 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipa->date_pa_parts_47 }}</td>
                                        <td>
                                            @if ($koneksipa->mny_parts_pa_47 != '')
                                                Rp{{ number_format($koneksipa->mny_parts_pa_47, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        ...
                                        <input type="text" hidden name="as_up_by_parts_pa_47"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pa_parts_47"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            @if ($koneksipa->pa_parts_48 != '')
                                                <a href="{{ asset('storage/supervisor/project/03_02_PR/' . $koneksipa->pa_parts_48) }}"
                                                    target="blank" class=" py-2 px-1 rounded  hover:bg-gray-200   ">
                                                    <svg width="22" height="17" viewBox="0 0 22 17"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_02_PR/' . $koneksipa->pa_parts_48) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipa->pa_parts_48 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipa->up_by_parts_pa_48 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipa->up_by_parts_pa_48 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipa->date_pa_parts_48 }}</td>
                                        <td>
                                            @if ($koneksipa->mny_parts_pa_48 != '')
                                                Rp{{ number_format($koneksipa->mny_parts_pa_48, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        ...
                                        <input type="text" hidden name="as_up_by_parts_pa_48"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pa_parts_48"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            @if ($koneksipa->pa_parts_49 != '')
                                                <a href="{{ asset('storage/supervisor/project/03_02_PR/' . $koneksipa->pa_parts_49) }}"
                                                    target="blank" class=" py-2 px-1 rounded  hover:bg-gray-200   ">
                                                    <svg width="22" height="17" viewBox="0 0 22 17"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_02_PR/' . $koneksipa->pa_parts_49) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipa->pa_parts_49 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipa->up_by_parts_pa_49 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipa->up_by_parts_pa_49 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipa->date_pa_parts_49 }}</td>
                                        <td>
                                            @if ($koneksipa->mny_parts_pa_49 != '')
                                                Rp{{ number_format($koneksipa->mny_parts_pa_49, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        ...
                                        <input type="text" hidden name="as_up_by_parts_pa_49"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pa_parts_49"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            @if ($koneksipa->pa_parts_50 != '')
                                                <a href="{{ asset('storage/supervisor/project/03_02_PR/' . $koneksipa->pa_parts_50) }}"
                                                    target="blank" class=" py-2 px-1 rounded  hover:bg-gray-200   ">
                                                    <svg width="22" height="17" viewBox="0 0 22 17"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_02_PR/' . $koneksipa->pa_parts_50) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipa->pa_parts_50 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipa->up_by_parts_pa_50 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipa->up_by_parts_pa_50 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipa->date_pa_parts_50 }}</td>
                                        <td>
                                            @if ($koneksipa->mny_parts_pa_50 != '')
                                                Rp{{ number_format($koneksipa->mny_parts_pa_50, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        ...
                                        <input type="text" hidden name="as_up_by_parts_pa_50"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pa_parts_50"
                                            value="{{ date('Y-m-d') }}">
                        ...
                        {{-- awal standar formulir --}}
                        <div class="flex justify-between">
                            <p class="font-medium text-lg bg-gray-800 px-4 py-1 w-fit text-white mb-2 rounded"> PA Pekerjaan/Jasa
                            @foreach ($standar_project as $spt)
                        ...
                        {{-- awal standar formulir --}}
                        <div class="flex justify-between">
                            <p class="font-medium text-lg bg-gray-800 px-4 py-1 w-fit text-white mb-2 rounded"> PA Manufaktur
                            @foreach ($standar_project as $spt)
            ...
            <input type="text" name="status_pa_02" value="Waiting Approval" hidden>
