...
<div class="mx-10 my-20">
    ...
    <div class="tracking-wide text-gray-600 mb-2">
        <p class=" font-light text-3xl mb-4">Projects Detail - PA:</p>
    </div>
    {{-- akhir header --}}
    ...
    <div class="bg-white  mt-10  w-full rounded-t">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="text" hidden name="aktivitas"
                value="{{ Auth::user()->first_name }} - Memperbarui Purchasing -> Purchase Approval pada project id={{ $viewdataproject->id }}">
