...
<div class="mx-10 my-20">
    ...
    <div class="tracking-wide text-gray-600 mb-2">
        <p class=" font-light text-3xl mb-4">Projects Detail - PO:</p>
    </div>
    {{-- akhir header --}}
    ...
    <div class=" flex overflow-x-auto">
        <div class="w-full">
            ...
            <div class="justify-between flex">
                <div class="max-w-3xl">
                    <div class="container">
                        <p class="mb-1 text-3xl font-semibold tracking-normal text-gray-900">
    ...
    <div class="bg-white  mt-10  w-full rounded-t">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="text" hidden name="aktivitas"
                value="{{ Auth::user()->first_name }} - Memperbarui Purchasing -> Purchase Order pada project id= {{ $viewdataproject->id }}">
