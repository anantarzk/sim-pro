                            ...
                            <tr class="bg-white border border-gray-300 hover:bg-gray-100 text-center">
                                ...
                                <td>
                                    ...
                                    @if ($object->progress == 'Closed')
                                        <div
                                            class=" space-x-1 font-medium items-center py-1 px-3 text-center text-lg rounded-xl drop-shadow-md flex justify-center w-fit bg-green-700 text-white">
                                    ...
                                    @else
                                        @if ($deadline > 150)
                                            <div
                                                class="items-center py-1 px-2 text-center text-lg rounded drop-shadow-md flex justify-center w-fit bg-green-500 text-white">
                                                {{ $deadline }} hari
                                            </div>
                                        @elseif ($deadline > 100)
                                            <div
                                                class="items-center py-1 px-2 text-center text-lg rounded drop-shadow-md flex justify-center w-fit bg-blue-500 text-white">
                                                {{ $deadline }} hari
                                            </div>
                                        @elseif ($deadline > 70)
                                            <div
                                                class="items-center py-1 px-2 text-center text-lg rounded drop-shadow-md flex justify-center w-fit bg-yellow-400 text-white">
                                                {{ $deadline }} hari
                                            </div>
                                        @elseif ($deadline > 30)
                                            <div
                                                class="items-center py-1 px-2 text-center text-lg rounded drop-shadow-md flex justify-center w-fit bg-orange-400 text-white">
                                                {{ $deadline }} hari
                                            </div>
                                        @else
                                            <div
                                                class="items-center py-1 px-2 text-center text-lg rounded drop-shadow-md flex justify-center w-fit bg-red-600 text-white">
                                                {{ $deadline }} hari
                                            </div>
                                        @endif
                                    @endif
