                ...
                <table class="w-full">
                    ...
                    <tbody class="text-left border">
                        ...
                        <tr class="hover:-translate-y-1 hover:scale-102 hover:bg-gray-100 duration-200 border-b">
                            ...
                            <td><input type="file" name="as_atribut_1" id=""></td>
                        ...
                        <tr class="hover:-translate-y-1 hover:scale-102 hover:bg-gray-100 duration-200 border-b">
                            ...
                            <td><input type="file" name="as_atribut_2" id=""></td>
                        ...
                        <tr class="hover:-translate-y-1 hover:scale-102 hover:bg-gray-100 duration-200 border-b">
                            ...
                            <td><input type="file" name="as_atribut_3" id=""></td>
                        ...
                        <tr class="hover:-translate-y-1 hover:scale-102 hover:bg-gray-100 duration-200 border-b">
                            ...
                            <td><input type="file" name="as_atribut_4" id=""></td>
                        ...
                        <tr class="hover:-translate-y-1 hover:scale-102 hover:bg-gray-100 duration-200 border-b">
                            ...
                            <td><input type="file" name="as_atribut_5" id=""></td>
