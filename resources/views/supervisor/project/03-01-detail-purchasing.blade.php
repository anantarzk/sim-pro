...
{{-- ini seharusnya conditional dari seluruh inputan file --}}
@if (
    $koneksipr->pr_parts_1 ||
        $koneksipr->pr_parts_2 ||
        $koneksipr->pr_parts_3 ||
    ...
    <div class="grid grid-cols-2 gap-2 mt-3">
        ...
        @endif
        @if ($koneksipr->status_pr_01 != 'Revisi Purchasing - PR' && $koneksipay->status_pay_04 != 'Complete' && $koneksicl->status_cl != 'Complete')
            <form action="" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <input type="text" name="check" value="donecheck" hidden>
