...
<div class="mx-10 my-20">
    ...
    @endif
    <input type="text" hidden name="as_up_by_mnftr_pr_2" value="{{ Auth::user()->first_name }}">
    <input type="date" hidden name="as_date_pr_mnftr_2" value="{{ date('Y-m-d') }}">
    </tr>
    ...
    <tr class="hover:-translate-y-1 hover:scale-102 hover:bg-gray-100 duration-200 border-b">
        ...
        <td class="flex items-center my-10">
            ...
            @endif
            {{--  --}}
            <a href="{{ asset('storage/supervisor/project/03_01_PR/' . $koneksipr->pr_mnftr_3) }}" target="blank"
        ...
        <td class="space-y-2 py-3 px-2">
            @if ($koneksipr->pr_mnftr_3 != '')
                <div class="justify-center flex space-x-2">
                    ...
                    <button data-dropdown-toggle="dropdown33" type="button"
                        class=" text-white bg-red-500 hover:bg-red-600 p-3 rounded-md">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="22" fill="white"
                            viewBox="0 0 48 48">
                            <path
                                d="M 24 4 C 20.491685 4 17.570396 6.6214322 17.080078 10 L 10.238281 10 A 1.50015 1.50015 0 0 0 9.9804688 9.9785156 A 1.50015 1.50015 0 0 0 9.7578125 10 L 6.5 10 A 1.50015 1.50015 0 1 0 6.5 13 L 8.6386719 13 L 11.15625 39.029297 C 11.427329 41.835926 13.811782 44 16.630859 44 L 31.367188 44 C 34.186411 44 36.570826 41.836168 36.841797 39.029297 L 39.361328 13 L 41.5 13 A 1.50015 1.50015 0 1 0 41.5 10 L 38.244141 10 A 1.50015 1.50015 0 0 0 37.763672 10 L 30.919922 10 C 30.429604 6.6214322 27.508315 4 24 4 z M 24 7 C 25.879156 7 27.420767 8.2681608 27.861328 10 L 20.138672 10 C 20.579233 8.2681608 22.120844 7 24 7 z M 11.650391 13 L 36.347656 13 L 33.855469 38.740234 C 33.730439 40.035363 32.667963 41 31.367188 41 L 16.630859 41 C 15.331937 41 14.267499 40.033606 14.142578 38.740234 L 11.650391 13 z M 20.476562 17.978516 A 1.50015 1.50015 0 0 0 19 19.5 L 19 34.5 A 1.50015 1.50015 0 1 0 22 34.5 L 22 19.5 A 1.50015 1.50015 0 0 0 20.476562 17.978516 z M 27.476562 17.978516 A 1.50015 1.50015 0 0 0 26 19.5 L 26 34.5 A 1.50015 1.50015 0 1 0 29 34.5 L 29 19.5 A 1.50015 1.50015 0 0 0 27.476562 17.978516 z">
                            </path>
            ...
            @else
                ...
                <div class="">
                    <input type="number" id="base-input"
                        class="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5"
                        placeholder="Rp (isi nilai sesuai dokumen PR)" min="0" max="999999999999"
                        oninput="validity.valid||(value='');" name="as_mny_mnftr_pr_3">
                </div>
        </td>
        @endif

        </td>
        <input type="text" hidden name="as_up_by_mnftr_pr_3" value="{{ Auth::user()->first_name }}">
        <input type="date" hidden name="as_date_pr_mnftr_3" value="{{ date('Y-m-d') }}">
    ...
    <tr class="hover:-translate-y-1 hover:scale-102 hover:bg-gray-100 duration-200 border-b">
        ...
        <td class="flex items-center my-10">
            ...
            @endif
            {{--  --}}
            <a href="{{ asset('storage/supervisor/project/03_01_PR/' . $koneksipr->pr_mnftr_4) }}" target="blank"
                download="" class="hover:underline">
            ...
            @else
                ...
                <div class="">
                    <input type="number" id="base-input"
                        class="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5"
                        placeholder="Rp (isi nilai sesuai dokumen PR)" min="0" max="999999999999"
                        oninput="validity.valid||(value='');" name="as_mny_mnftr_pr_4">
                </div>
            @endif

        </td>
        <input type="text" hidden name="as_up_by_mnftr_pr_4" value="{{ Auth::user()->first_name }}">
        <input type="date" hidden name="as_date_pr_mnftr_4" value="{{ date('Y-m-d') }}">
    ...
    <tr class="hover:-translate-y-1 hover:scale-102 hover:bg-gray-100 duration-200 border-b">
        ...
        <td class="flex items-center my-10">
            ...
            @endif
            {{--  --}}
            <a href="{{ asset('storage/supervisor/project/03_01_PR/' . $koneksipr->pr_mnftr_5) }}" target="blank"
                download="" class="hover:underline">
            ...
            @else
                ...
                <div class="">
                    <input type="number" id="base-input"
                        class="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5"
                        placeholder="Rp (isi nilai sesuai dokumen PR)" min="0" max="999999999999"
                        oninput="validity.valid||(value='');" name="as_mny_mnftr_pr_5">
                </div>
            @endif

        </td>
        <input type="text" hidden name="as_up_by_mnftr_pr_5" value="{{ Auth::user()->first_name }}">
        <input type="date" hidden name="as_date_pr_mnftr_5" value="{{ date('Y-m-d') }}">
    ...
    <tr class="hover:-translate-y-1 hover:scale-102 hover:bg-gray-100 duration-200 border-b">
        ...
        <td class="flex items-center my-10">
            ...
            @endif
            {{--  --}}
            <a href="{{ asset('storage/supervisor/project/03_01_PR/' . $koneksipr->pr_mnftr_6) }}" target="blank"
                download="" class="hover:underline">
            ...
            @else
                ...
                <div class="" id="submit-1">
                    <input type="number" id="base-input"
                        class="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5"
                        placeholder="Rp (isi nilai sesuai dokumen PR)" min="0" max="999999999999"
                        oninput="validity.valid||(value='');" name="as_mny_mnftr_pr_6">
                </div>
            @endif

        </td>
        <input type="text" hidden name="as_up_by_mnftr_pr_6" value="{{ Auth::user()->first_name }}">
        <input type="date" hidden name="as_date_pr_mnftr_6" value="{{ date('Y-m-d') }}">
    ...
    <tr class="hover:-translate-y-1 hover:scale-102 hover:bg-gray-100 duration-200 border-b">
        ...
        <td class="flex items-center my-10">
            ...
            @endif
            {{--  --}}
            <a href="{{ asset('storage/supervisor/project/03_01_PR/' . $koneksipr->pr_mnftr_7) }}" target="blank"
                download="" class="hover:underline">
            ...
            @else
                ...
                <div class="">
                    <input type="number" id="base-input"
                        class="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5"
                        placeholder="Rp (isi nilai sesuai dokumen PR)" min="0" max="999999999999"
                        oninput="validity.valid||(value='');" name="as_mny_mnftr_pr_7">
                </div>
            @endif

        </td>
        <input type="text" hidden name="as_up_by_mnftr_pr_7" value="{{ Auth::user()->first_name }}">
        <input type="date" hidden name="as_date_pr_mnftr_7" value="{{ date('Y-m-d') }}">
    ...
    <tr class="hover:-translate-y-1 hover:scale-102 hover:bg-gray-100 duration-200 border-b">
        ...
        <td class="flex items-center my-10">
            ...
            @endif
            {{--  --}}
            <a href="{{ asset('storage/supervisor/project/03_01_PR/' . $koneksipr->pr_mnftr_8) }}" target="blank"
                download="" class="hover:underline">
            ...
            @else
                ...
                <div class="">
                    <input type="number" id="base-input"
                        class="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5"
                        placeholder="Rp (isi nilai sesuai dokumen PR)" min="0" max="999999999999"
                        oninput="validity.valid||(value='');" name="as_mny_mnftr_pr_8">
                </div>
            @endif

        </td>
        <input type="text" hidden name="as_up_by_mnftr_pr_8" value="{{ Auth::user()->first_name }}">
        <input type="date" hidden name="as_date_pr_mnftr_8" value="{{ date('Y-m-d') }}">
    ...
    <tr class="hover:-translate-y-1 hover:scale-102 hover:bg-gray-100 duration-200 border-b">
        ...
        <td class="flex items-center my-10">
            ...
            @endif
            {{--  --}}
            <a href="{{ asset('storage/supervisor/project/03_01_PR/' . $koneksipr->pr_mnftr_9) }}" target="blank"
                download="" class="hover:underline">
            ...
            @else
                ...
                <div class="">
                    <input type="number" id="base-input"
                        class="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5"
                        placeholder="Rp (isi nilai sesuai dokumen PR)" min="0" max="999999999999"
                        oninput="validity.valid||(value='');" name="as_mny_mnftr_pr_9">
                </div>
            @endif

        </td>
        <input type="text" hidden name="as_up_by_mnftr_pr_9" value="{{ Auth::user()->first_name }}">
        <input type="date" hidden name="as_date_pr_mnftr_9" value="{{ date('Y-m-d') }}">
    ...
    <tr class="hover:-translate-y-1 hover:scale-102 hover:bg-gray-100 duration-200 border-b">
        ...
        <td class="flex items-center my-10">
            ...
            @endif
            {{--  --}}
            <a href="{{ asset('storage/supervisor/project/03_01_PR/' . $koneksipr->pr_mnftr_10) }}" target="blank"
                download="" class="hover:underline">
            ...
            @else
                ...
                <div class="">
                    <input type="number" id="base-input"
                        class="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5"
                        placeholder="Rp (isi nilai sesuai dokumen PR)" min="0" max="999999999999"
                        oninput="validity.valid||(value='');" name="as_mny_mnftr_pr_10">
                </div>
            @endif

        </td>
        <input type="text" hidden name="as_up_by_mnftr_pr_10" value="{{ Auth::user()->first_name }}">
        <input type="date" hidden name="as_date_pr_mnftr_10" value="{{ date('Y-m-d') }}">
...
{{-- awal tab impor --}}
<div class="mt-3 bg-white rounded-lg" id="impor" role="tabpanel" aria-labelledby="impor-tab">
    {{-- PR PER --}}
    {{-- awal standar formulir --}}
    <div class="flex justify-between">
            ...
            @if ($spt->file_pr_rfq_form != '' || $spt->file_pr_per_form)
                ...
                <div class="flex items-center justify-end mr-1 mt-4 space-x-2">
                    <a href="{{ asset('storage/supervisor/standarproject/' . $spt->file_pr_rfq_form) }}"
                        download="">
                        <div class="w-fit items-center space-x-2 flex fill-blue-600 hover:fill-blue-800">
                            <svg width="15" height="" viewBox="0 0 52 52"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="m36.4 14.8h8.48a1.09 1.09 0 0 0 1.12-1.12 1 1 0 0 0 -.32-.8l-10.56-10.56a1 1 0 0 0 -.8-.32 1.09 1.09 0 0 0 -1.12 1.12v8.48a3.21 3.21 0 0 0 3.2 3.2z" />
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="items-center px-5 py-2 border-t border-gray-200 rounded-b">
                    ...
                    <p class="text-sm font-bold">*Pastikan isi kedua bidang isian (file & nilai finansial) untuk dapat
                        mengubah ajuan</p>
