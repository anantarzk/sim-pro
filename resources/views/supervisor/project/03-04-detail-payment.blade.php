}}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_parts_pay_43 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_parts_pay_43 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_parts_43 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_parts_pay_43 != '')
                                                Rp{{ number_format($koneksipay->mny_parts_pay_43, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        ...
                                        <input type="text" hidden name="as_up_by_parts_pay_43"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_parts_43"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_parts_44) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_parts_44 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_parts_pay_44 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_parts_pay_44 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_parts_44 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_parts_pay_44 != '')
                                                Rp{{ number_format($koneksipay->mny_parts_pay_44, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        ...
                                        <input type="text" hidden name="as_up_by_parts_pay_44"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_parts_44"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_parts_45) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_parts_45 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_parts_pay_45 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_parts_pay_45 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_parts_45 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_parts_pay_45 != '')
                                                Rp{{ number_format($koneksipay->mny_parts_pay_45, 0, ',', '.') }}
                                            @endif
                                        </td>
                                ...
                                <tbody class="text-left border">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_1) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_1 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_1 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_1 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_1 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_1 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_1, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_1"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_1"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_2) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_2 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_2 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_2 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_2 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_2 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_2, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_2"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_2"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_3) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_3 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_3 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_3 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_3 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_3 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_3, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_3"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_3"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_4) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_4 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_4 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_4 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_4 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_4 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_4, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_4"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_4"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_5) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_5 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_5 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_5 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_5 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_5 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_5, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_6) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_6 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_6 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_6 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_6 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_6 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_6, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_6"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_6"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_7) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_7 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_7 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_7 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_7 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_7 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_7, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_7"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_7"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_8) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_8 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_8 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_8 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_8 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_8 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_8, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_8"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_8"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_9) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_9 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_9 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_9 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_9 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_9 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_9, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_9"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_9"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_10) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_10 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_10 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_10 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_10 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_10 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_10, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_10"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_10"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_11) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_11 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_11 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_11 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_11 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_11 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_11, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_11"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_11"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_12) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_12 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_12 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_12 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_12 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_12 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_12, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_12"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_12"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_13) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_13 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_13 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_13 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_13 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_13 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_13, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_13"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_13"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_14) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_14 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_14 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_14 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_14 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_14 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_14, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_14"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_14"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_15) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_15 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_15 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_15 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_15 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_15 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_15, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_15"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_15"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_16) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_16 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_16 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_16 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_16 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_16 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_16, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_16"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_16"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_17) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_17 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_17 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_17 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_17 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_17 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_17, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_17"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_17"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_18) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_18 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_18 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_18 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_18 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_18 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_18, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_18"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_18"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_19) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_19 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_19 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_19 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_19 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_19 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_19, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_21) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_21 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_21 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_21 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_21 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_21 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_21, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_21"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_21"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_22) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_22 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_22 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_22 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_22 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_22 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_22, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_22"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_22"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_23) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_23 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_23 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_23 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_23 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_23 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_23, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_23"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_23"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_24) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_24 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_24 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_24 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_24 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_24 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_24, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_24"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_24"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_25) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_25 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_25 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_25 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_25 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_25 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_25, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_25"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_25"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_26) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_26 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_26 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_26 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_26 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_26 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_26, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_26"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_26"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_27) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_27 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_27 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_27 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_27 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_27 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_27, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_27"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_27"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_28) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_28 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_28 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_28 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_28 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_28 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_28, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_28"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_28"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_29) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_29 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_29 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_29 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_29 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_29 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_29, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_29"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_29"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_jasa_30) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_jasa_30 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_jasa_pay_30 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_jasa_pay_30 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_jasa_30 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_jasa_pay_30 != '')
                                                Rp{{ number_format($koneksipay->mny_jasa_pay_30, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_jasa_pay_30"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_jasa_30"
                                            value="{{ date('Y-m-d') }}">
                                ...
                                <tbody class="text-left border">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_mnftr_1) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_mnftr_1 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_mnftr_pay_1 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_mnftr_pay_1 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_mnftr_1 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_mnftr_pay_1 != '')
                                                Rp{{ number_format($koneksipay->mny_mnftr_pay_1, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_mnftr_pay_1"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_mnftr_1"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_mnftr_2) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_mnftr_2 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_mnftr_pay_2 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_mnftr_pay_2 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_mnftr_2 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_mnftr_pay_2 != '')
                                                Rp{{ number_format($koneksipay->mny_mnftr_pay_2, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_mnftr_3) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_mnftr_3 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_mnftr_pay_3 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_mnftr_pay_3 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_mnftr_3 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_mnftr_pay_3 != '')
                                                Rp{{ number_format($koneksipay->mny_mnftr_pay_3, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_mnftr_pay_3"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_mnftr_3"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_mnftr_4) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_mnftr_4 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_mnftr_pay_4 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_mnftr_pay_4 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_mnftr_4 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_mnftr_pay_4 != '')
                                                Rp{{ number_format($koneksipay->mny_mnftr_pay_4, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_mnftr_pay_4"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_mnftr_4"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_mnftr_5) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_mnftr_5 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_mnftr_pay_5 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_mnftr_pay_5 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_mnftr_5 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_mnftr_pay_5 != '')
                                                Rp{{ number_format($koneksipay->mny_mnftr_pay_5, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_mnftr_pay_5"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_mnftr_5"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_mnftr_6) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_mnftr_6 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_mnftr_pay_6 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_mnftr_pay_6 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_mnftr_6 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_mnftr_pay_6 != '')
                                                Rp{{ number_format($koneksipay->mny_mnftr_pay_6, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_mnftr_pay_6"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_mnftr_6"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_mnftr_7) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_mnftr_7 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_mnftr_pay_7 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_mnftr_pay_7 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_mnftr_7 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_mnftr_pay_7 != '')
                                                Rp{{ number_format($koneksipay->mny_mnftr_pay_7, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_mnftr_pay_7"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_mnftr_7"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_mnftr_8) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_mnftr_8 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_mnftr_pay_8 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_mnftr_pay_8 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_mnftr_8 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_mnftr_pay_8 != '')
                                                Rp{{ number_format($koneksipay->mny_mnftr_pay_8, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_mnftr_pay_8"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_mnftr_8"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_mnftr_9) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_mnftr_9 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_mnftr_pay_9 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_mnftr_pay_9 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_mnftr_9 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_mnftr_pay_9 != '')
                                                Rp{{ number_format($koneksipay->mny_mnftr_pay_9, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
                                        ...
                                        <input type="text" hidden name="as_up_by_mnftr_pay_9"
                                            value="{{ Auth::user()->first_name }}">
                                        <input type="date" hidden name="as_date_pay_mnftr_9"
                                            value="{{ date('Y-m-d') }}">
                                    ...
                                    <tr
                                        ...
                                        <td class="flex items-center my-10">
                                            ...
                                            <a href="{{ asset('storage/supervisor/project/03_04_PR/' . $koneksipay->pay_mnftr_10) }}"
                                                target="blank" download="" class="hover:underline">
                                                {{ $koneksipay->pay_mnftr_10 }}</a>
                                            {{-- == --}}

                                        </td>
                                        <td>
                                            @if ($koneksipay->up_by_mnftr_pay_10 != '')
                                                <div
                                                    class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-[100] mx-auto rounded">
                                                    {{ $koneksipay->up_by_mnftr_pay_10 }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="text-center">{{ $koneksipay->date_pay_mnftr_10 }}</td>
                                        <td>
                                            @if ($koneksipay->mny_mnftr_pay_10 != '')
                                                Rp{{ number_format($koneksipay->mny_mnftr_pay_10, 0, ',', '.') }}
                                            @endif
                                        </td>
                                        <td class="space-y-2 py-3 px-2">
            ...
            <input type="text" hidden name="aktivitas"
                value="{{ Auth::user()->first_name }} - Memperbarui dan Menyetujui Purchasing -> Payment pada project id= {{ $viewdataproject->id }}">
        ...
        <div class="grid grid-cols-2 gap-2">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                {{-- input ke table log activity --}}
                <input type="text" hidden name="aktivitas"
                    value="{{ Auth::user()->first_name }} - Menyetujui Purchasing -> Payment pada project id= {{ $viewdataproject->id }}">
                <input type="text" hidden name="waktu" value="{{ date('d-m-Y H:i') }}">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                {{-- input ke table log activity --}}
                <input type="text" hidden name="aktivitas"
                    value="{{ Auth::user()->first_name }} - Memberi Revisi Purchasing -> Payment pada project id= {{ $viewdataproject->id }}">
                <input type="text" hidden name="waktu" value="{{ date('d-m-Y H:i') }}">
