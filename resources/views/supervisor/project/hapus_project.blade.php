...
<div class="container my-20 mx-auto">
    ...
    <a href="/seluruh-proyek-supervisor-manager" class="mx-6 text-lg  font-medium font-mono hover:underline text-blue-500 hover:text-blue-600">< Kembali</a>

    <div class="mx-6 mt-4 px-8 pt-5 pb-3 bg-white shadow-md rounded">

        <p class="font-bold text-gray-800 text-3xl mb-3">Konfirmasi Hapus Proyek </p>
