    ...
    <div id="DeadlineCheck">
        ...
        <?php if(
            ...
            <div class="grid grid-cols-2 gap-2 mt-3">
                ...
                <?php endif; ?>
                <?php if($koneksifr->status_fr != 'Revisi Fund Request' && $koneksicl->status_cl != 'Complete'): ?>
                    <form action="" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        <input type="text" name="check" value="donecheck" hidden>
...
<?php echo $__env->make('layouts.layout_supervisor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\simpro_TA\sim-pro\resources\views/supervisor/project/01-detail-fundrequest.blade.php ENDPATH**/ ?>