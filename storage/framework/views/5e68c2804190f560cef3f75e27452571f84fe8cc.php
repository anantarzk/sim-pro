    ...
    <div class="mt-6 2xl:flex-row space-y-4 2xl:space-y-0 2xl:space-x-4 rounded-lg">
        <div class="w-full ">
            <div class="bg-white rounded-lg shadow-xl border-2">
                ...
                <div class="flex space-x-8 mx-12 my-5">
                ...
                <div class="border-t-2  ">
                    <div class="mx-12 my-1 flex space-x-20">
                        <div class="py-2">
...
<?php echo $__env->make('layouts.layout_supervisor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\simpro_TA\sim-pro\resources\views/layouts/layout_viewprofilesupervisor.blade.php ENDPATH**/ ?>