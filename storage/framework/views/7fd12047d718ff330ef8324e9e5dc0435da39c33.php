...
<head>
    ...
    <title><?php echo $__env->yieldContent('title_page'); ?> | Supervisor</title>
...
<body class="bg-gray-200">
    ...
    <div id="sidebar"
        ...
        <div class="p-2">
            <div>
                <?php if(Auth::user()->jabatan == 'Manager Eng Design'): ?>
                    <p id="sidebar-label" class="text-2xl font-bold text-white uppercase">
                        MANAGER</p>
                <?php elseif(Auth::user()->jabatan == 'Asst. Manager'): ?>
                    <p id="sidebar-label" class="text-2xl font-bold text-white uppercase">
                        Asst. MANAGER</p>
                <?php else: ?>
                    <p id="sidebar-label" class="text-2xl font-bold text-white uppercase">
...
<?php /**PATH C:\xampp\htdocs\simpro_TA\sim-pro\resources\views/layouts/layout_supervisor.blade.php ENDPATH**/ ?>