...
<div class="mx-10 my-20">
            ...
            <div class="flex items-center">
                ...
                <div class="flex items-center relative">
                    ...
                    <div class="absolute top-0 -ml-10 text-center mt-14 w-32 text-sm font-medium">
                        <a
                            href="/staff-02-arrangement-proyek/<?php echo e($viewdataproject->id); ?>/<?php echo e($koneksifr->id_fr_1); ?>/<?php echo e($koneksiar->id_ar_2); ?>/<?php echo e($koneksipr->id_pr_01_3); ?>/<?php echo e($koneksipa->id_pa_02_3); ?>/<?php echo e($koneksipo->id_po_03_3); ?>/<?php echo e($koneksipay->id_pay_04_3); ?>/<?php echo e($koneksimn->id_mn_4); ?>/<?php echo e($koneksiin->id_in_5); ?>/<?php echo e($koneksicl->id_cl_6); ?>">
                ...
                <div class="flex items-center relative">
                    ...
                    <div class="absolute top-0 -ml-10 text-center mt-14 w-32 text-sm font-medium">
                        <a
                            href="/staff-03-01-PR-purchasing-proyek/<?php echo e($viewdataproject->id); ?>/<?php echo e($koneksifr->id_fr_1); ?>/<?php echo e($koneksiar->id_ar_2); ?>/<?php echo e($koneksipr->id_pr_01_3); ?>/<?php echo e($koneksipa->id_pa_02_3); ?>/<?php echo e($koneksipo->id_po_03_3); ?>/<?php echo e($koneksipay->id_pay_04_3); ?>/<?php echo e($koneksimn->id_mn_4); ?>/<?php echo e($koneksiin->id_in_5); ?>/<?php echo e($koneksicl->id_cl_6); ?>">
                ...
                <div class="flex items-center relative">
                    ...
                    <div class="absolute top-0 -ml-10 text-center mt-14 w-32 text-sm font-medium">
                        <a
                            href="/staff-04-manufacturing-proyek/<?php echo e($viewdataproject->id); ?>/<?php echo e($koneksifr->id_fr_1); ?>/<?php echo e($koneksiar->id_ar_2); ?>/<?php echo e($koneksipr->id_pr_01_3); ?>/<?php echo e($koneksipa->id_pa_02_3); ?>/<?php echo e($koneksipo->id_po_03_3); ?>/<?php echo e($koneksipay->id_pay_04_3); ?>/<?php echo e($koneksimn->id_mn_4); ?>/<?php echo e($koneksiin->id_in_5); ?>/<?php echo e($koneksicl->id_cl_6); ?>">
                ...
                <div class="flex items-center relative">
                    ...
                    <div class="absolute top-0 -ml-10 text-center mt-14 w-32 text-sm font-medium">
                        <a
                            href="/staff-06-closed-proyek/<?php echo e($viewdataproject->id); ?>/<?php echo e($koneksifr->id_fr_1); ?>/<?php echo e($koneksiar->id_ar_2); ?>/<?php echo e($koneksipr->id_pr_01_3); ?>/<?php echo e($koneksipa->id_pa_02_3); ?>/<?php echo e($koneksipo->id_po_03_3); ?>/<?php echo e($koneksipay->id_pay_04_3); ?>/<?php echo e($koneksimn->id_mn_4); ?>/<?php echo e($koneksiin->id_in_5); ?>/<?php echo e($koneksicl->id_cl_6); ?>">
        ...
        <div class="bg-white mt-3 w-full rounded-md shadow-md p-3">
            <div class="flex justify-between items-center">
                <div class="flex">
                    ...
                    <div
                        ...
                        <?php echo e($koneksifr->approval_by); ?>
                    ...
                    <p class="font-semibold">
                        <?php echo e($koneksifr->approval_date); ?>
                ...
                <?php if($koneksifr->status_fr == 'Complete'): ?>
                    ...
                    <div class="bg-green-600 flex  py-1 px-2   items-center rounded">
                        ...
                        <div class="text-white font-medium ml-3">
                            <p>
                                <?php echo e($koneksifr->status_fr); ?>

                            </p>
                        </div>
                    </div>
                <?php elseif($koneksifr->status_fr == '-'): ?>
                ...
                <?php elseif($koneksifr->status_fr == 'Waiting Approval'): ?>
            ...
            <div class="flex justify-between">
                ...
                <?php $__currentLoopData = $standar_project; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($spt->file_fr_sheet_form != ''): ?>
                        <div class="flex justify-end mr-1 mt-4">
                            <a href="<?php echo e(asset('storage/supervisor/standarproject/' . $spt->file_fr_sheet_form)); ?>"
                                download="">
                        ...
                        <tbody class="text-left border">
                            <tr class="hover:-translate-y-1 hover:scale-102 hover:bg-gray-100 duration-200 border-b">
                                ...
                                <td class="flex justify-start py-4 items-center">
                                    <?php if($koneksifr->atribut_1 != ''): ?>
                                        <a href="<?php echo e(asset('storage/supervisor/project/01_FR/' . $koneksifr->atribut_1)); ?>"
                                    ...
                                    <a href="<?php echo e(asset('storage/supervisor/project/01_FR/' . $koneksifr->atribut_1)); ?>"
                                        ...
                                        <?php echo e($koneksifr->atribut_1); ?></a>
                                    
                                </td>
                                <td>
                                    <?php if($koneksifr->up_by_1 != ''): ?>
                                        <div
                                            class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-fit mx-auto rounded">
                                            <?php echo e($koneksifr->up_by_1); ?>

                                        </div>
                                    <?php endif; ?>
                                </td>
                                <td class="text-center"><?php echo e($koneksifr->date_atribut_1); ?></td>
                                <td>
                                    <?php if(($koneksifr->status_fr == '-' || $koneksifr->status_fr == 'Revisi Fund Request') && $koneksifr->atribut_1 == ''): ?>
                                ...
                                <input type="date" hidden name="as_date_atribut_1" value="<?php echo e(date('Y-m-d')); ?>">
                            </tr>
                            ...
                            <tr class="hover:-translate-y-1 hover:scale-102 hover:bg-gray-100 duration-200 border-b">
                                ...
                                <td class="flex justify-start py-4 items-center">
                                    ...
                                    <?php if($koneksifr->atribut_2 != ''): ?>
                                        <a href="<?php echo e(asset('storage/supervisor/project/01_FR/' . $koneksifr->atribut_2)); ?>"
                                            target="blank" class="py-2 px-1 rounded hover:bg-gray-200 ">
                                            <svg width="22" height="17" viewBox="0 0 22 17" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <a href="<?php echo e(asset('storage/supervisor/project/01_FR/' . $koneksifr->atribut_2)); ?>"
                                        target="blank" download="" class="hover:underline ">
                                        <?php echo e($koneksifr->atribut_2); ?></a>
                                    
                                </td>
                                <td>
                                    <?php if($koneksifr->up_by_2 != ''): ?>
                                        <div
                                            class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-fit mx-auto rounded">
                                            <?php echo e($koneksifr->up_by_2); ?>

                                        </div>
                                    <?php endif; ?>
                                </td>
                                <td class="text-center"><?php echo e($koneksifr->date_atribut_2); ?></td>
                                <td>
                                    <?php if(($koneksifr->status_fr == '-' || $koneksifr->status_fr == 'Revisi Fund Request') && $koneksifr->atribut_2 == ''): ?>
                                ...
                                <input type="text" hidden name="as_up_by_2"
                                    value="<?php echo e(Auth::user()->first_name); ?>">
                                <input type="date" hidden name="as_date_atribut_2" value="<?php echo e(date('Y-m-d')); ?>">
                            </tr>
                            ...
                            <tr class="hover:-translate-y-1 hover:scale-102 hover:bg-gray-100 duration-200 border-b">
                                ...
                                <td class="flex justify-start py-4 items-center">
                                    ...
                                    <?php if($koneksifr->atribut_3 != ''): ?>
                                        <a href="<?php echo e(asset('storage/supervisor/project/01_FR/' . $koneksifr->atribut_3)); ?>"
                                            target="blank" class="py-2 px-1 rounded hover:bg-gray-200 ">
                                            <svg width="22" height="17" viewBox="0 0 22 17" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <a href="<?php echo e(asset('storage/supervisor/project/01_FR/' . $koneksifr->atribut_3)); ?>"
                                        target="blank" download="" class="hover:underline">
                                        <?php echo e($koneksifr->atribut_3); ?></a>
                                    

                                </td>
                                <td>
                                    <?php if($koneksifr->up_by_3 != ''): ?>
                                        <div
                                            class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-fit mx-auto rounded">
                                            <?php echo e($koneksifr->up_by_3); ?>

                                        </div>
                                    <?php endif; ?>
                                </td>
                                <td class="text-center"><?php echo e($koneksifr->date_atribut_3); ?></td>
                                <td>
                                    <?php if(($koneksifr->status_fr == '-' || $koneksifr->status_fr == 'Revisi Fund Request') && $koneksifr->atribut_3 == ''): ?>
                                ...
                                <input type="text" hidden name="as_up_by_3"
                                    value="<?php echo e(Auth::user()->first_name); ?>">
                                <input type="date" hidden name="as_date_atribut_3" value="<?php echo e(date('Y-m-d')); ?>">
                            </tr>
                            ...
                            <tr class="hover:-translate-y-1 hover:scale-102 hover:bg-gray-100 duration-200 border-b">
                                ...
                                <td class="flex justify-start py-4 items-center">
                                    ...
                                    <?php if($koneksifr->atribut_4 != ''): ?>
                                        <a href="<?php echo e(asset('storage/supervisor/project/01_FR/' . $koneksifr->atribut_4)); ?>"
                                            target="blank" class="py-2 px-1 rounded hover:bg-gray-200">
                                            <svg width="22" height="17" viewBox="0 0 22 17" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <a href="<?php echo e(asset('storage/supervisor/project/01_FR/' . $koneksifr->atribut_4)); ?>"
                                        target="blank" download="" class="hover:underline ">
                                        <?php echo e($koneksifr->atribut_4); ?></a>
                                    

                                </td>
                                <td>
                                    <?php if($koneksifr->up_by_4 != ''): ?>
                                        <div
                                            class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-fit mx-auto rounded">
                                            <?php echo e($koneksifr->up_by_4); ?>

                                        </div>
                                    <?php endif; ?>
                                </td>
                                <td class="text-center"><?php echo e($koneksifr->date_atribut_4); ?></td>
                                <td>
                                    <?php if(($koneksifr->status_fr == '-' || $koneksifr->status_fr == 'Revisi Fund Request') && $koneksifr->atribut_4 == ''): ?>
                                ...
                                <input type="text" hidden name="as_up_by_4"
                                    value="<?php echo e(Auth::user()->first_name); ?>">
                                <input type="date" hidden name="as_date_atribut_4" value="<?php echo e(date('Y-m-d')); ?>">
                            </tr>
                            ...
                            <tr class="hover:-translate-y-1 hover:scale-102 hover:bg-gray-100 duration-200 border-b">
                                ...
                                <td class="flex justify-start py-4 items-center">
                                    ...
                                    <?php if($koneksifr->atribut_5 != ''): ?>
                                        <a href="<?php echo e(asset('storage/supervisor/project/01_FR/' . $koneksifr->atribut_5)); ?>"
                                            target="blank" class=" py-2 px-1 rounded hover:bg-gray-200   ">
                                            <svg width="22" height="17" viewBox="0 0 22 17" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <a href="<?php echo e(asset('storage/supervisor/project/fr/' . $koneksifr->atribut_5)); ?>"
                                        target="blank" download="" class="hover:underline">
                                        <?php echo e($koneksifr->atribut_5); ?></a>
                                    

                                </td>
                                <td>
                                    <?php if($koneksifr->up_by_5 != ''): ?>
                                        <div
                                            class="items-center py-1 px-2 text-sm font-medium text-center text-white bg-orange-500 w-fit mx-auto rounded">
                                            <?php echo e($koneksifr->up_by_5); ?>

                                        </div>
                                    <?php endif; ?>
                                </td>
                                <td class="text-center"><?php echo e($koneksifr->date_atribut_5); ?></td>
                                <td>
                                    <?php if(($koneksifr->status_fr == '-' || $koneksifr->status_fr == 'Revisi Fund Request') && $koneksifr->atribut_5 == ''): ?>
                                ...
                                <input type="text" hidden name="as_up_by_5"
                                    value="<?php echo e(Auth::user()->first_name); ?>">
                                <input type="date" hidden name="as_date_atribut_5" value="<?php echo e(date('Y-m-d')); ?>">
                            </tr>
                        </tbody>
                    </table>
                </div>
                            ...
                            <div class="relative bg-white rounded-lg shadow">
                                    ...
                                    <div class="grid grid-cols-2 space-x-2">
                                        <div class="overflow-auto">
                                            ...
                                            <p class="text-gray-900">
                                                <?php echo e($koneksifr->{'atribut_' . $number}); ?>
                                        ...
                                        <div class="overflow-auto">
                                            ...
                                            <p class="text-gray-900">
                                                <?php echo e($koneksifr->{'up_by_' . $number}); ?>
                                ...
                                <div class="items-center px-5 py-2 border-t border-gray-200 rounded-b">
                                    ...
                                    <div class="items-center justify-center w-full border my-4">
                                        <?php if($koneksifr->{'atribut_' . $number} != ''): ?>
                                            <input type="file"name="as_atribut_<?php echo e($number); ?>"
                                                id="">
                                        <?php else: ?>
                                        <?php endif; ?>
                                    </div>
    ...
    <?php if($koneksifr->status_fr == '-' || $koneksifr->status_fr == 'Revisi Fund Request'): ?>
        <?php if(
            $koneksifr->atribut_1 ||
                $koneksifr->atribut_2 ||
                $koneksifr->atribut_3 ||
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <input type="date" hidden name="status_fr_date" value="<?php echo e(date('Y-m-d')); ?>">
    ...
    <?php $__currentLoopData = $num; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $number): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div id="dropdown<?php echo e($number); ?>" class="z-10 hidden bg-gray-800 rounded-lg w-110% p-4 shadow-md">
                <?php if($number): ?>
                    <input type="text" hidden name="up_by_<?php echo e($number); ?>" value="">
                    <input type="text" hidden name="date_atribut_<?php echo e($number); ?>" value="">
                    <input type="text" hidden name="atribut_<?php echo e($number); ?>" value="">
                <?php endif; ?>
...
<?php echo $__env->make('layouts.layout_staff', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sim-pro\resources\views/staff/project/01-detail-fundrequest.blade.php ENDPATH**/ ?>