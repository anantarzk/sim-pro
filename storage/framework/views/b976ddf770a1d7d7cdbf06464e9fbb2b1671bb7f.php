...
<body>
    ...
    <div class="w-full h-screen flex flex-col items-center justify-center">
        <svg class="w-1/2 md:w-1/3 lg:w-1/4 text-orange-500" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
            ...
            <path d="M140.09162,291.85056c0-78.36865,54.255-141.78356,121.30372-141.78356"
                transform="translate(-31.39089 -100.5)" fill="currentColor"></path>
            ...
            <path
                ...
                transform="translate(-31.39089 -100.5)" fill="#a8a8a8"></path>
            <path
                ...
                transform="translate(-31.39089 -100.5)" opacity="0.2"></path>
            ...
            <path d="M494,726.5c90,23,263-30,282-90" transform="translate(-31.39089 -100.5)" fill="none"
                stroke="#2f2e41" stroke-miterlimit="10" stroke-width="2"></path>
            ...
            <path d="M215.40233,637.78332s39.0723-10.82,41.47675,24.04449-32.15951,44.78287-5.10946,51.69566"
                transform="translate(-31.39089 -100.5)" fill="none" stroke="#2f2e41" stroke-miterlimit="10"
                stroke-width="2"></path>
            <path
            ...
            <path
                ...
                transform="translate(-31.39089 -100.5)" opacity="0.1"></path>
            ...
            <rect x="271.60911" y="150" width="16" height="16" fill="currentColor" opacity="0.4">
            </rect>
            <rect x="294.60911" y="150" width="16" height="16" fill="currentColor" opacity="0.8">
            </rect>
            <rect x="317.60911" y="150" width="16" height="16" fill="currentColor"></rect>
            <rect x="271.60911" y="251" width="16" height="16" fill="currentColor" opacity="0.4">
            </rect>
            <rect x="294.60911" y="251" width="16" height="16" fill="currentColor" opacity="0.8">
            </rect>
            <rect x="317.60911" y="251" width="16" height="16" fill="currentColor"></rect>
            <rect x="271.60911" y="352" width="16" height="16" fill="currentColor" opacity="0.4">
            </rect>
            <rect x="294.60911" y="352" width="16" height="16" fill="currentColor" opacity="0.8">
            </rect>
            ...
            <ellipse cx="417.21511" cy="611.34365" rx="39.5" ry="12.40027"
                transform="translate(-238.28665 112.98044) rotate(-23.17116)" fill="#2f2e41"></ellipse>
            <ellipse cx="269.21511" cy="664.34365" rx="39.5" ry="12.40027"
                transform="translate(-271.07969 59.02084) rotate(-23.17116)" fill="#2f2e41"></ellipse>
            <path d="M394,661.5c0,7.732-19.90861,23-42,23s-43-14.268-43-22,20.90861-6,43-6S394,653.768,394,661.5Z"
                transform="translate(-31.39089 -100.5)" fill="#fff"></path>
        </svg>
        ...
        <div class="flex flex-col items-center justify-center">
            ...
            <p class="md:text-lg xl:text-xl text-gray-500 mt-4">Something went wrong on our servers.</p>
            <p class="md:text-lg lg:text-xl text-gray-600 mt-0 font-semibold">Engineering Design - SIMPro
            </p>
            <a href="/"
                class="flex items-center space-x-2 bg-orange-400 hover:bg-orange-500 text-black px-4 py-2 mt-12 rounded transition duration-150"
                title="Return Home">
...
<?php /**PATH C:\xampp\htdocs\sim-pro\resources\views/errors/500.blade.php ENDPATH**/ ?>